...
using WaterMeasurements.Controls;
using static WaterMeasurements.Models.PrePlannedMapConfiguration;

namespace WaterMeasurements.Controls;
...
public sealed class ValidationTextBox : ContentControl
{
    ...
    protected override void OnApplyTemplate()
    {
        ...
        // Check to see if the templates are available.
        if (textBox is null || warningIcon is null)
        {
            throw new Exception("Template parts are missing.");
        }
    ...
    /// </summary>
    private static void OnPropertyNamePropertyChanged(
        object sender,
    ...
    /// </summary>
    private void ValidationTextBox_DataContextChanged(
    ...
    {
        if (
            this.warningIcon is not FontIcon warningIcon
        ...
        ValidationResult result = dataContext
